...
# HERE I'M USING SQL SYNTAX TO CREATE THE TABLE THAT WILL HOLD THE DATA SET YOUR TEAM WILL USE
query = """
CREATE TABLE iris(
sepalLength FLOAT,
sepalWidth FLOAT, 
...
con.execute(query) # HERE WE TELL THE CONNECTION TO EXECUTE THE QUERY WHICH IS CREATING OUR TABLE
con.commit()
...
cursor = con.execute('SELECT * FROM iris')
